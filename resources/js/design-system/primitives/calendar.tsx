  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: cn(
          // The bar spans the caption row; only its buttons may catch clicks,
          // or it blankets the month/year dropdowns underneath.
      ...
      components={{
        ...
        Dropdown: ({ value, onChange, options, "aria-label": ariaLabel }) => {
          return (
            ...
            >
              <SelectTrigger size="sm" aria-label={ariaLabel} className="h-8 gap-1 border-none bg-transparent px-2 font-medium shadow-none">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                <SelectGroup>
